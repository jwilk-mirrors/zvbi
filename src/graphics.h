...
/* $Id: graphics.h,v 1.1.2.4 2004-04-15 00:11:16 mschimek Exp $ */
...
#ifdef __ZTV_GRAPHICS_H__

VBI_BEGIN_DECLS

#define VBI_PIXFMT_NONE TV_PIXFMT_NONE
#define VBI_PIXFMT_UNKNOWN TV_PIXFMT_UNKNOWN
#define VBI_PIXFMT_RESERVED0 TV_PIXFMT_RESERVED0
#define VBI_PIXFMT_YUV444 TV_PIXFMT_YUV444
#define VBI_PIXFMT_YVU444 TV_PIXFMT_YVU444
#define VBI_PIXFMT_YUV422 TV_PIXFMT_YUV422
#define VBI_PIXFMT_YVU422 TV_PIXFMT_YVU422
#define VBI_PIXFMT_YUV411 TV_PIXFMT_YUV411
#define VBI_PIXFMT_YVU411 TV_PIXFMT_YVU411
#define VBI_PIXFMT_YUV420 TV_PIXFMT_YUV420
#define VBI_PIXFMT_YVU420 TV_PIXFMT_YVU420
#define VBI_PIXFMT_YUV410 TV_PIXFMT_YUV410
#define VBI_PIXFMT_YVU410 TV_PIXFMT_YVU410
#define VBI_PIXFMT_YUVA24_LE TV_PIXFMT_YUVA24_LE
#define VBI_PIXFMT_YUVA24_BE TV_PIXFMT_YUVA24_BE
#define VBI_PIXFMT_YVUA24_LE TV_PIXFMT_YVUA24_LE
#define VBI_PIXFMT_YVUA24_BE TV_PIXFMT_YVUA24_BE
#define VBI_PIXFMT_AVUY24_BE TV_PIXFMT_AVUY24_BE
#define VBI_PIXFMT_AVUY24_LE TV_PIXFMT_AVUY24_LE
#define VBI_PIXFMT_AUVY24_BE TV_PIXFMT_AUVY24_BE
#define VBI_PIXFMT_AUVY24_LE TV_PIXFMT_AUVY24_LE
#define VBI_PIXFMT_YUV24_LE TV_PIXFMT_YUV24_LE
#define VBI_PIXFMT_YUV24_BE TV_PIXFMT_YUV24_BE
#define VBI_PIXFMT_YVU24_LE TV_PIXFMT_YVU24_LE
#define VBI_PIXFMT_YVU24_BE TV_PIXFMT_YVU24_BE
#define VBI_PIXFMT_VUY24_BE TV_PIXFMT_VUY24_BE
#define VBI_PIXFMT_VUY24_LE TV_PIXFMT_VUY24_LE
#define VBI_PIXFMT_UVY24_BE TV_PIXFMT_UVY24_BE
#define VBI_PIXFMT_UVY24_LE TV_PIXFMT_UVY24_LE
#define VBI_PIXFMT_YUYV TV_PIXFMT_YUYV
#define VBI_PIXFMT_YVYU TV_PIXFMT_YVYU
#define VBI_PIXFMT_UYVY TV_PIXFMT_UYVY
#define VBI_PIXFMT_VYUY TV_PIXFMT_VYUY
#define VBI_PIXFMT_RESERVED1 TV_PIXFMT_RESERVED1
#define VBI_PIXFMT_Y8 TV_PIXFMT_Y8
#define VBI_PIXFMT_RESERVED2 TV_PIXFMT_RESERVED2
#define VBI_PIXFMT_RESERVED3 TV_PIXFMT_RESERVED3
#define VBI_PIXFMT_RGBA24_LE TV_PIXFMT_RGBA24_LE
#define VBI_PIXFMT_RGBA24_BE TV_PIXFMT_RGBA24_BE
#define VBI_PIXFMT_BGRA24_LE TV_PIXFMT_BGRA24_LE
#define VBI_PIXFMT_BGRA24_BE TV_PIXFMT_BGRA24_BE
#define VBI_PIXFMT_ABGR24_BE TV_PIXFMT_ABGR24_BE
#define VBI_PIXFMT_ABGR24_LE TV_PIXFMT_ABGR24_LE
#define VBI_PIXFMT_ARGB24_BE TV_PIXFMT_ARGB24_BE
#define VBI_PIXFMT_ARGB24_LE TV_PIXFMT_ARGB24_LE
#define VBI_PIXFMT_RGB24_LE TV_PIXFMT_RGB24_LE
#define VBI_PIXFMT_RGB24_BE TV_PIXFMT_RGB24_BE
#define VBI_PIXFMT_BGR24_BE TV_PIXFMT_BGR24_BE
#define VBI_PIXFMT_BGR24_LE TV_PIXFMT_BGR24_LE
#define VBI_PIXFMT_RGB16_LE TV_PIXFMT_RGB16_LE
#define VBI_PIXFMT_RGB16_BE TV_PIXFMT_RGB16_BE
#define VBI_PIXFMT_BGR16_LE TV_PIXFMT_BGR16_LE
#define VBI_PIXFMT_BGR16_BE TV_PIXFMT_BGR16_BE
#define VBI_PIXFMT_RGBA15_LE TV_PIXFMT_RGBA15_LE
#define VBI_PIXFMT_RGBA15_BE TV_PIXFMT_RGBA15_BE
#define VBI_PIXFMT_BGRA15_LE TV_PIXFMT_BGRA15_LE
#define VBI_PIXFMT_BGRA15_BE TV_PIXFMT_BGRA15_BE
#define VBI_PIXFMT_ARGB15_LE TV_PIXFMT_ARGB15_LE
#define VBI_PIXFMT_ARGB15_BE TV_PIXFMT_ARGB15_BE
#define VBI_PIXFMT_ABGR15_LE TV_PIXFMT_ABGR15_LE
#define VBI_PIXFMT_ABGR15_BE TV_PIXFMT_ABGR15_BE
#define VBI_PIXFMT_RGBA12_LE TV_PIXFMT_RGBA12_LE
#define VBI_PIXFMT_RGBA12_BE TV_PIXFMT_RGBA12_BE
#define VBI_PIXFMT_BGRA12_LE TV_PIXFMT_BGRA12_LE
#define VBI_PIXFMT_BGRA12_BE TV_PIXFMT_BGRA12_BE
#define VBI_PIXFMT_ARGB12_LE TV_PIXFMT_ARGB12_LE
#define VBI_PIXFMT_ARGB12_BE TV_PIXFMT_ARGB12_BE
#define VBI_PIXFMT_ABGR12_LE TV_PIXFMT_ABGR12_LE
#define VBI_PIXFMT_ABGR12_BE TV_PIXFMT_ABGR12_BE
#define VBI_PIXFMT_RGB8 TV_PIXFMT_RGB8
#define VBI_PIXFMT_BGR8 TV_PIXFMT_BGR8
#define VBI_PIXFMT_RGBA7 TV_PIXFMT_RGBA7
#define VBI_PIXFMT_BGRA7 TV_PIXFMT_BGRA7
#define VBI_PIXFMT_ARGB7 TV_PIXFMT_ARGB7
#define VBI_PIXFMT_ABGR7 TV_PIXFMT_ABGR7

typedef tv_pixfmt vbi_pixfmt;
typedef tv_pixfmt_set vbi_pixfmt_set;

#define VBI_MAX_PIXFMTS TV_MAX_PIXFMTS

#define VBI_PIXFMT_SET TV_PIXFMT_SET
#define VBI_PIXFMT_SET_UNKNOWN TV_PIXFMT_SET_UNKNOWN
#define VBI_PIXFMT_SET_EMPTY TV_PIXFMT_SET_EMPTY
#define VBI_PIXFMT_SET_YUV_PLANAR TV_PIXFMT_SET_YUV_PLANAR
#define VBI_PIXFMT_SET_YUVA24 TV_PIXFMT_SET_YUVA24
#define VBI_PIXFMT_SET_YUV24 TV_PIXFMT_SET_YUV24
#define VBI_PIXFMT_SET_YUV16 TV_PIXFMT_SET_YUV16
#define VBI_PIXFMT_SET_YUV_PACKED TV_PIXFMT_SET_YUV_PACKED
#define VBI_PIXFMT_SET_YUV TV_PIXFMT_SET_YUV
#define VBI_PIXFMT_SET_RGBA24 TV_PIXFMT_SET_RGBA24
#define VBI_PIXFMT_SET_RGB24 TV_PIXFMT_SET_RGB24
#define VBI_PIXFMT_SET_RGB16 TV_PIXFMT_SET_RGB16
#define VBI_PIXFMT_SET_RGB15 TV_PIXFMT_SET_RGB15
#define VBI_PIXFMT_SET_RGB12 TV_PIXFMT_SET_RGB12
#define VBI_PIXFMT_SET_RGB8 TV_PIXFMT_SET_RGB8
#define VBI_PIXFMT_SET_RGB7 TV_PIXFMT_SET_RGB7
#define VBI_PIXFMT_SET_RGB_PACKED TV_PIXFMT_SET_RGB_PACKED
#define VBI_PIXFMT_SET_RGB TV_PIXFMT_SET_RGB
#define VBI_PIXFMT_SET_PLANAR TV_PIXFMT_SET_PLANAR
#define VBI_PIXFMT_SET_PACKED TV_PIXFMT_SET_PACKED
#define VBI_PIXFMT_SET_ALL TV_PIXFMT_SET_ALL
#define VBI_PIXFMT_IS_YUV TV_PIXFMT_IS_YUV
#define VBI_PIXFMT_IS_RGB TV_PIXFMT_IS_RGB
#define VBI_PIXFMT_IS_PLANAR TV_PIXFMT_IS_PLANAR
#define VBI_PIXFMT_IS_PACKED TV_PIXFMT_IS_PACKED

#define vbi_pixfmt_bytes_per_pixel tv_pixfmt_bytes_per_pixel
#define vbi_pixfmt_name tv_pixfmt_name

#define	VBI_COLOR_SPACE_NONE TV_COLOR_SPACE_NONE
#define VBI_COLOR_SPACE_UNKNOWN TV_COLOR_SPACE_UNKNOWN

typedef tv_color_space vbi_color_space;
typedef tv_image_format vbi_image_format;

/* vbi_image_format functions,
   vbi_pixel_format not needed here. */

VBI_END_DECLS

#else /* !__ZTV_GRAPHICS_H__ */
...
#define _VBI_PIXFMT_SET_4	(VBI_PIXFMT_SET_YUVA24 |		\
				 VBI_PIXFMT_SET_RGBA24)
#define _VBI_PIXFMT_SET_3	(VBI_PIXFMT_SET_YUV24 |			\
	 			 VBI_PIXFMT_SET_RGB24)
#define _VBI_PIXFMT_SET_2	(VBI_PIXFMT_SET_YUV16 |			\
				 VBI_PIXFMT_SET_RGB16 |			\
				 VBI_PIXFMT_SET_RGB15 |			\
				 VBI_PIXFMT_SET_RGB12)
#define _VBI_PIXFMT_SET_1	(VBI_PIXFMT_SET_YUV_PLANAR |		\
				 VBI_PIXFMT_SET (VBI_PIXFMT_Y8) |	\
				 VBI_PIXFMT_SET_RGB8 |			\
				 VBI_PIXFMT_SET_RGB7)
#endif
...
#define vbi_pixfmt_bytes_per_pixel(pixfmt)				\
	(!__builtin_constant_p (pixfmt) ?				\
	 _vbi_pixfmt_bytes_per_pixel (pixfmt) :				\
	  ((VBI_PIXFMT_SET (pixfmt) & _VBI_PIXFMT_SET_4) ? 4U :		\
	   ((VBI_PIXFMT_SET (pixfmt) & _VBI_PIXFMT_SET_3) ? 3U :	\
	    ((VBI_PIXFMT_SET (pixfmt) & _VBI_PIXFMT_SET_2) ? 2U :	\
	     ((VBI_PIXFMT_SET (pixfmt) & _VBI_PIXFMT_SET_1) ? 1U :	\
	      0U)))))
#else
/**
