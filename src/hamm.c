...
/* $Id: hamm.c,v 1.3.2.6 2008-02-27 07:57:34 mschimek Exp $ */
				 ...
				 unsigned int		c)
{
	...
	Byte_0 = (_vbi3_hamm24_fwd_0 [(c >> 0) & 0xFF]
		  ^ _vbi3_hamm24_fwd_1 [(c >> 8) & 0xFF]
		  ^ _vbi3_hamm24_fwd_2 [(c >> 16) & 0x03]);
	p[0] = Byte_0;

	D5_D11 = (c >> 4) & 0x7F;
	D12_D18 = (c >> 11) & 0x7F;

	P5 = 0x80 & ~(_vbi3_hamm24_inv_par[0][D12_D18] << 2);
	p[1] = D5_D11 | P5;

	P6 = 0x80 & ((_vbi3_hamm24_inv_par[0][Byte_0]
		      ^ _vbi3_hamm24_inv_par[0][D5_D11]) << 2);
	p[2] = D12_D18 | P6;
}
