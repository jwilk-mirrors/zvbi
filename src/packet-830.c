...
/* $Id: packet-830.c,v 1.2 2009-02-16 13:40:24 mschimek Exp $ */
...
/**
 * @param time The time in seconds since Epoch (1970-01-01 00:00 UTC)
 *   will be stored here.
 ...
 *   time of the intended audience add @a seconds_east to @a time.
 * @param buffer Teletext packet as defined for @c VBI_SLICED_TELETEXT_B,
 *   i.e. 42 bytes without clock run-in and framing code.
 * 
 * Decodes a Teletext packet 8/30 format 1 according to
