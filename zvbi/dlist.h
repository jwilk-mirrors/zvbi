...
/* $Id: dlist.h,v 1.1.2.1 2008-08-19 10:56:02 mschimek Exp $ */
 ...
 * a pointer of same type as p, used to remember the _succ struct node
 * in the list. This permits unlink_node(p) in the loop. Resist the
 * temptation to unlink p->_succ or p->_pred. l points to the list to
 * traverse.  _node is the name of the struct node element. Example:
 *
