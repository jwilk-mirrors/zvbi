...
static const int
service_map [][2] = {
	{ VBI3_SLICED_TELETEXT_B,			42 },
	{ VBI3_SLICED_CAPTION_625,			2 },
	{ VBI3_SLICED_VPS | VBI3_SLICED_VPS_F2,		13 },
	{ VBI3_SLICED_WSS_625,				2 },
	{ VBI3_SLICED_WSS_CPR1204,			3 },
	{ 0, 0 },
	{ 0, 0 },
	{ VBI3_SLICED_CAPTION_525,			2 }
};
				 ...
				 unsigned int		max_lines)
{
	...
	*timestamp = read_elapsed + dt;
	read_elapsed = *timestamp;
